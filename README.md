...
Test the API: Open your browser or use:
cmdcurl http://127.0.0.1:8000
Expect a 200 OK response with {"service": "InsightAgent API", "status": "running", ...}.
Test a Query: Use a tool like Postman or:
cmd
...
Log in at railway.app and link your GitHub repository.
...
GROQ_API_KEY
AUTH_TOKEN
CACHE_DIR=/app/faiss_index (optional, defaults to this).
...
Enable Docker integration and deploy via:
bashrailway up

Test the deployed endpoint with the same curl command, using your Railway URL.
